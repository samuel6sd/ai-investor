...
def app():
    ...
    # Datos
    st.subheader('Datos de los últimos 60 días de ' + com)
    st.write(df.tail(60))
    df['Date'] = data.index
    ...
    # X2 : Media del precio de cierre para una ventana de 60 días
    x2_train = []
    for h in x1_train:
      sma = np.mean(h[:,0])
    ...
    # Se realiza una predicción para el día actual y el día siguiente
    ...
    # Previsión de si el precio va a subir o a bajar en función a los 60 últimos días
